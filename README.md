...
![Alt Text](https://github.com/qnsosusong/Hindex/master/04_images/API_demo.png "api")

The web UI enables the visualization of the author's publication and collaboration as the first author.
![Alt Text](https://github.com/qnsosusong/Hindex/master/04_images/UI_query.png "service")

## The data pipeline
![Alt Text](https://github.com/qnsosusong/Hindex/master/04_images/pipeline.png "Data Pipeline")
